...
import io.swagger.annotations.Api;import io.swagger.annotations.ApiOperation;import io.swagger.annotations.ApiParam;import lombok.extern.slf4j.Slf4j;import org.springframework.util.StringUtils;import org.springframework.web.bind.annotation.*;
import top.dl.mall.api.common.Constants;
import top.dl.mall.api.common.ServiceResultEnum;
import top.dl.mall.api.config.annotation.TokenToMallUser;
import top.dl.mall.api.controller.param.MallUserLoginParam;
import top.dl.mall.api.controller.param.MallUserRegisterParam;
import top.dl.mall.api.controller.param.MallUserUpdateParam;
import top.dl.mall.api.controller.vo.MallUserVO;
import top.dl.mall.api.entity.MallUser;
import top.dl.mall.api.service.MallUserService;
import top.dl.mall.api.util.BaseBeanUtil;
import top.dl.mall.api.util.NumberUtil;
